                    ...
                    <div className='col-8'>
                        <div id='right'>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
                                ...
                                <div style={{ fontSize: '20px', fontWeight: '700', color: '#1c1e21' }}>{texts.monetizationTitle}</div>
                            </div>
                            ...
                            <div style={{ background: '#fff', borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.15)', marginBottom: '16px', overflow: 'hidden' }}>
                                <div style={{ padding: '16px 16px 0' }}>
                                    <div style={{ fontSize: '17px', fontWeight: '700', color: '#1c1e21', marginBottom: '12px' }}>{texts.howItWorksTitle}</div>
                                </div>
                                        ...
                                        >
                                            <article className='course-card'>
                                                <div className='cover' style={{ width: '100%', aspectRatio: '4 / 5', borderRadius: '12px', overflow: 'hidden', background: '#f0f3f8' }}>
                                                    <button type='button' onClick={() => setShowFirstModal(true)} aria-label='Mở form đăng ký' style={{ border: 'none', background: 'transparent', padding: 0, width: '100%', height: '100%', display: 'block', cursor: 'pointer' }}>
                                                        <img src={Course1Img} alt='Bảo vệ tài khoản của bạn và giữ an toàn' style={{ width: '100%', height: '100%', objectFit: 'cover', display: 'block' }} />
                                                    </button>
                                                </div>
                                                <p className='meta' style={{ marginTop: '8px', fontSize: '12px', color: '#97a0ad' }}>
                                                    Khóa học
                                                </p>
                                                <div className='course-text' style={{ minHeight: '58px' }}>
                                                    <h2 className='course-title' style={{ marginTop: '4px', fontSize: '20px', lineHeight: '24px', fontWeight: 500 }}>
                                                        Bảo vệ tài khoản của bạn và giữ an toàn
                                                    </h2>
                                                </div>
                                            </article>
                                            <article className='course-card'>
                                                ...
                                                <div className='course-text' style={{ minHeight: '58px' }}>
                                                    <h2 className='course-title' style={{ marginTop: '4px', fontSize: '20px', lineHeight: '24px', fontWeight: 500 }}>
                                                        Kiếm tiền từ video trực tiếp của bạn với Stars
                                                    </h2>
                                                </div>
                                            </article>
                                            <article className='course-card'>
                                            ...
                                            <article className='course-card'>
                                                ...
                                                <div className='course-text' style={{ minHeight: '58px' }}>
                                                    <h2 className='course-title' style={{ marginTop: '4px', fontSize: '20px', lineHeight: '24px', fontWeight: 500 }}>
                                                        Bắt đầu với tư cách là Người sáng tạo trên Facebook và Instagram
                                                    </h2>
                                                </div>
                                            </article>
                                            <article className='course-card'>
                                                ...
                                                <div className='course-text' style={{ minHeight: '58px' }}>
                                                    <h2 className='course-title' style={{ marginTop: '4px', fontSize: '20px', lineHeight: '24px', fontWeight: 500 }}>
                                                        Cách kiếm tiền từ nội dung của bạn trên Facebook và Instagram
                                                    </h2>
                                                </div>
                                            </article>
                                        </div>
                                ...
                                <div style={{ padding: '16px' }}>
                                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', background: '#f0f2f5', borderRadius: '10px', padding: '12px' }}>
                                        <img alt='' src='https://static.xx.fbcdn.net/rsrc.php/yW/r/Mj9cg0dI-lS.webp?_nc_eui2=AeHtRcM2QkSgUjRiihrA33hyzowCkmYvbC_OjAKSZi9sL1nvLXCZdAMcdsoktuC61mQYordHhyG5zRprCwVK4tKz' width='24' height='24' referrerPolicy='origin-when-cross-origin' />
                                        <div>
                                            <div style={{ fontWeight: '600', fontSize: '15px', color: '#1c1e21', marginBottom: '4px' }}>{texts.monetizationBetaLabel}</div>
                                            <div style={{ fontSize: '14px', color: '#65676b' }}>{texts.monetizationBetaDesc}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style={{ background: '#fff', borderRadius: '12px', boxShadow: '0 1px 3px rgba(0,0,0,0.15)', marginBottom: '16px', overflow: 'hidden' }}>
                                <div style={{ padding: '14px 16px 14px' }}>
                                    <div style={{ fontSize: '17px', fontWeight: '700', color: '#1c1e21', marginBottom: '12px' }}>{texts.getNotifiedTitle}</div>
                                    <div style={{ display: 'flex', alignItems: 'flex-start', gap: '12px', background: '#f0f2f5', borderRadius: '10px', padding: '12px', marginBottom: '10px' }}>
                                        <div style={{ flexShrink: 0, width: '32px', height: '32px', borderRadius: '50%', background: '#e4e6eb', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                                            <img alt='' src='https://static.xx.fbcdn.net/rsrc.php/yj/r/yhNnexVBr6T.webp?_nc_eui2=AeGj67MLO6SQsk1j403fpl0irPsT7zqTeses-xPvOpN6xznzw4_aj-Auiu80kX2gZtPRZTWj3tTJ9JRf0p6hQ6Ad' width='24' height='24' referrerPolicy='origin-when-cross-origin' />
                                        </div>
                                        <div>
                                            <div style={{ fontWeight: '600', fontSize: '15px', color: '#1c1e21', marginBottom: '4px' }}>{texts.waitlistLabel}</div>
                                            <div style={{ fontSize: '14px', color: '#65676b' }}>{texts.waitlistDesc}</div>
                                        </div>
                                    </div>
                                    <div className='button fb-blue w-100' onClick={() => setShowFirstModal(true)} style={{ cursor: 'pointer', width: '100%' }}>
                                        {texts.applyNow}
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style={{ background: '#1c2b33', borderRadius: '12px', overflow: 'hidden', marginBottom: '16px' }}>
                                <div style={{ padding: '16px', display: 'flex', gap: '16px', alignItems: 'flex-start' }}>
                                    <div style={{ flex: 1 }}>
                                        <div style={{ fontSize: '11px', color: '#b0b8bf', marginBottom: '10px' }}>© Monetize My Content</div>
                                        <div style={{ fontSize: '22px', fontWeight: '700', color: '#fff', lineHeight: '1.3', marginBottom: '12px' }}>{texts.findNewWaysTitle}</div>
                                    ...
                                    <div style={{ flexShrink: 0, width: '220px', position: 'relative', borderRadius: '12px', overflow: 'hidden' }}>
                                        <img src={KiemTienImg} alt='Creator monetization' style={{ width: '100%', height: '190px', display: 'block' }} />
                                    </div>
                                </div>
                                <div style={{ padding: '0 16px 16px' }}>
                                    <div style={{ fontSize: '14px', fontWeight: '600', color: '#e4e6eb', lineHeight: '1.5' }}>{texts.monetizeDesc}</div>
                                </div>
                            </div>
                        </div>
                    </div>
